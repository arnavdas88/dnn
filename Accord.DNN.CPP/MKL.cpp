...
extern "C" __declspec(dllexport) void WINAPI mkl_sger(
	BOOL rowmajor,
	int m, int n,
	const float* x, int offx,
...
extern "C" __declspec(dllexport) void WINAPI mkl_sgemv(
	BOOL rowmajor,
	int m, int n,
...
extern "C" __declspec(dllexport) void WINAPI mkl_sgemm(
	BOOL rowmajor,
	int m, int k, int n,
	const float* a, int offa, BOOL transa,
...
extern "C" __declspec(dllexport) void WINAPI mkl_stransm(
	BOOL rowmajor,
	int rows, int cols,
	float* ab, int offab)
{
...
extern "C" __declspec(dllexport) void WINAPI mkl_pack(
	int n,
	const float* a, int offa, int inca,
	float* y, int offy)
{
...
extern "C" __declspec(dllexport) void WINAPI mkl_unpack(
	int n,
	const float* a, int offa,
	float* y, int offy, int incy)
{
