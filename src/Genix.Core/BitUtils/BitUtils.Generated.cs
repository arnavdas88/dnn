...
//     Generated on: 9/25/2018 5:00:56 PM
//
...
namespace Genix.Core
{
    ...
    public static class BitUtils
    {
        ...
        /// <summary>
        /// Examines the bit at the specified position in the array of 32-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to examine.</param>
        /// <param name="position">The bit position to test.</param>
        /// <returns>
        ...
        /// <summary>
        /// Sets the bit at the specified position in the array of 32-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to reset.</param>
        /// <param name="position">The bit position to reset.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Resets the bit at the specified position in the array of 32-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to reset.</param>
        /// <param name="position">The bit position to reset.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Sets the range bits at the specified starting position in the array of 32-bit unsigned integers.
        /// </summary>
        ...
        /// <summary>
        /// Sets the range bits at the specified starting position in the array of 32-bit unsigned integers to the specified mask.
        /// </summary>
        /// <param name="count">The number of bits to set.</param>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetBits(int count, uint mask, uint[] bits, int position)
        {
            NativeMethods.bits_set_mask_32(count, mask, bits, position);
        }

        /// <summary>
        /// Resets the range bits at the specified starting position in the array of 32-bit unsigned integers.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the range of bits in two arrays of 32-bit unsigned integers at the specified positions
        /// are equal.
        /// </summary>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Equals(int count, uint[] x, int posx, uint[] y, int posy)
        {
            return NativeMethods.bits_equals_32(count, x, posx, y, posy);
        }
        ...
        /// <summary>
        /// Shifts a range of bits from a source array of 32-bit unsigned integers to the left (from LSB to MSB).
        /// </summary>
        ...
        /// <param name="posx">The starting bit position in <paramref name="x"/>.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Shl(int count, int shift, uint[] x, int posx)
        {
            NativeMethods.bits_shl_32(count, shift, x, posx);
        }

        /// <summary>
        /// Shifts a range of bits from a source array of 32-bit unsigned integers to the right (from MSB to LSB).
        /// </summary>
        /// <param name="count">The number of bits to shift.</param>
        /// <param name="shift">The number of bits by which the method shifts each element.</param>
        /// <param name="x">The bits to shift.</param>
        /// <param name="posx">The starting bit position in <paramref name="x"/>.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Shr(int count, int shift, uint[] x, int posx)
        {
            NativeMethods.bits_shr_32(count, shift, x, posx);
        }
        ...
        /// <param name="xy">The source and destination array.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void BiteSwap(int length, uint* xy)
        {
        ...
        /// <summary>
        /// Examines the bit at the specified position in the array of 64-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to examine.</param>
        /// <param name="position">The bit position to test.</param>
        /// <returns>
        ...
        /// <summary>
        /// Sets the bit at the specified position in the array of 64-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to reset.</param>
        /// <param name="position">The bit position to reset.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Resets the bit at the specified position in the array of 64-bit unsigned integers.
        /// </summary>
        /// <param name="bits">The bits to reset.</param>
        /// <param name="position">The bit position to reset.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Sets the range bits at the specified starting position in the array of 64-bit unsigned integers.
        /// </summary>
        /// <param name="count">The number of bits to set.</param>
        /// <param name="bits">The bits to set.</param>
        /// <param name="position">The starting bit position to set.</param>
        ...
        /// <summary>
        /// Sets the range bits at the specified starting position in the array of 64-bit unsigned integers to the specified mask.
        /// </summary>
        /// <param name="count">The number of bits to set.</param>
        /// <param name="mask">The bit mask to set.</param>
        /// <param name="bits">The bits to set.</param>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetBits(int count, ulong mask, ulong[] bits, int position)
        {
            NativeMethods.bits_set_mask_64(count, mask, bits, position);
        }

        /// <summary>
        /// Resets the range bits at the specified starting position in the array of 64-bit unsigned integers.
        /// </summary>
        /// <param name="count">The number of bits to reset.</param>
        /// <param name="bits">The bits to reset.</param>
        /// <param name="position">The starting bit position to reset.</param>
        ...
        /// <summary>
        /// Determines whether the range of bits in two arrays of 64-bit unsigned integers at the specified positions
        /// are equal.
        /// </summary>
        /// <param name="count">The number of bits to test.</param>
        /// <param name="x">The first source bits.</param>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Equals(int count, ulong[] x, int posx, ulong[] y, int posy)
        {
            return NativeMethods.bits_equals_64(count, x, posx, y, posy);
        }
        ...
        /// <summary>
        /// Shifts a range of bits from a source array of 64-bit unsigned integers to the left (from LSB to MSB).
        /// </summary>
        /// <param name="count">The number of bits to shift.</param>
        /// <param name="shift">The number of bits by which the method shifts each element.</param>
        /// <param name="x">The bits to shift.</param>
        /// <param name="posx">The starting bit position in <paramref name="x"/>.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Shl(int count, int shift, ulong[] x, int posx)
        {
            NativeMethods.bits_shl_64(count, shift, x, posx);
        }

        /// <summary>
        /// Shifts a range of bits from a source array of 64-bit unsigned integers to the right (from MSB to LSB).
        /// </summary>
        /// <param name="count">The number of bits to shift.</param>
        /// <param name="shift">The number of bits by which the method shifts each element.</param>
        /// <param name="x">The bits to shift.</param>
        /// <param name="posx">The starting bit position in <paramref name="x"/>.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Shr(int count, int shift, ulong[] x, int posx)
        {
            NativeMethods.bits_shr_64(count, shift, x, posx);
        }
        ...
        /// <param name="xy">The source and destination array.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void BiteSwap(int length, ulong* xy)
        {
            NativeMethods.bytesswap_ip_64(length, xy, 0);
        }
        ...
        private static class NativeMethods
        {
            ...
            public static extern bool bits_equals_32(int count, [In] uint[] x, int posx, [In] uint[] y, int posy);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_set_32(int count, [In, Out] uint[] bits, int pos);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_set_mask_32(int count, uint mask, [In, Out] uint[] bits, int pos);
            ...
            [DllImport(NativeMethods.DllName)]
            public static extern void bits_shl_32(int count, int shift, [In] uint[] x, int posx);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_shr_32(int count, int shift, [In] uint[] x, int posx);
            ...
            [DllImport(NativeMethods.DllName)]
            [return: MarshalAs(UnmanagedType.Bool)]
            public static extern bool bits_equals_64(int count, [In] ulong[] x, int posx, [In] ulong[] y, int posy);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_set_64(int count, [In, Out] ulong[] bits, int pos);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_set_mask_64(int count, ulong mask, [In, Out] ulong[] bits, int pos);
            ...
            [DllImport(NativeMethods.DllName)]
            public static extern void bits_shl_64(int count, int shift, [In] ulong[] x, int posx);

            [DllImport(NativeMethods.DllName)]
            public static extern void bits_shr_64(int count, int shift, [In] ulong[] x, int posx);
            ...
            [DllImport(NativeMethods.DllName)]
            public static extern unsafe void bytesswap_ip_64(int n, [In, Out] ulong* xy, int offxy);
