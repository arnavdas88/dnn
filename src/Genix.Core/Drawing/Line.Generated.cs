...
//     Generated on: 10/26/2018 3:19:19 PM
//
...
namespace Genix.Drawing
{
        ...
        : IEquatable<Line>
    {
        ...
        public int Y(int x)
        {
            ...
            return (int)Math.Round(((double)(x - this.x1) * (this.y2 - this.y1) / (this.x2 - this.x1)) + this.y1 + Line.Eps, MidpointRounding.AwayFromZero);
        }
        ...
        public int X(int y)
        {
            ...
            return (int)Math.Round(((double)(y - this.y1) * (this.x2 - this.x1) / (this.y2 - this.y1)) + this.x1 + Line.Eps, MidpointRounding.AwayFromZero);
        }
