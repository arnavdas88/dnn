...
//     Generated on: 11/14/2018 5:19:48 PM
//
...
namespace Genix.Drawing
{
        ...
        : IEquatable<Point>
    {
        ...
        public static Point Scale(Point point, float dx, float dy)
        {
            ...
            return new Point((dx * point.x).Round(), (dy * point.y).Round());
        }
        ...
        /// <summary>
        /// Computes the Euclidean distance between this <see cref="Point"/> and the specified point.
        /// </summary>
        ...
        /// <returns>
        /// A value that represents the squared Euclidean distance between this <see cref="Point"/> and the specified point.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float DistanceTo(int x, int y) => (float)Math.Sqrt(this.DistanceToSquared(x, y));
        ...
        /// <summary>
        /// Computes the squared Euclidean distance between this <see cref="Point"/> and the specified point.
        /// </summary>
        /// <param name="x">The x-coordinate of the point to compute the distance to.</param>
        /// <param name="y">The y-coordinate of the point to compute the distance to.</param>
        /// <returns>
        /// A value that represents the squared Euclidean distance between this <see cref="Point"/> and the specified point.
        /// </returns>
        public int DistanceToSquared(int x, int y)
        {
            int dx = this.x - x;
            int dy = this.y - y;
            return (dx * dx) + (dy * dy);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int DistanceToSquared(Point point) => this.DistanceToSquared(point.X, point.Y);
    }
        ...
        : IEquatable<PointF>
    {
        ...
        /// <summary>
        /// Computes the Euclidean distance between this <see cref="PointF"/> and the specified point.
        /// </summary>
        /// <param name="x">The x-coordinate of the point to compute the distance to.</param>
        /// <param name="y">The y-coordinate of the point to compute the distance to.</param>
        /// <returns>
        /// A value that represents the squared Euclidean distance between this <see cref="PointF"/> and the specified point.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float DistanceTo(float x, float y) => (float)Math.Sqrt(this.DistanceToSquared(x, y));
        ...
        /// <summary>
        /// Computes the squared Euclidean distance between this <see cref="PointF"/> and the specified point.
        /// </summary>
        /// <param name="x">The x-coordinate of the point to compute the distance to.</param>
        /// <param name="y">The y-coordinate of the point to compute the distance to.</param>
        /// <returns>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float DistanceToSquared(PointF point) => this.DistanceToSquared(point.X, point.Y);
    }
        ...
        : IEquatable<PointD>
    {
        ...
        /// <summary>
        /// Computes the Euclidean distance between this <see cref="PointD"/> and the specified point.
        /// </summary>
        /// <param name="x">The x-coordinate of the point to compute the distance to.</param>
        /// <param name="y">The y-coordinate of the point to compute the distance to.</param>
        /// <returns>
        /// A value that represents the squared Euclidean distance between this <see cref="PointD"/> and the specified point.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double DistanceTo(double x, double y) => Math.Sqrt(this.DistanceToSquared(x, y));
        ...
        /// <summary>
        /// Computes the squared Euclidean distance between this <see cref="PointD"/> and the specified point.
        /// </summary>
        /// <param name="x">The x-coordinate of the point to compute the distance to.</param>
        /// <param name="y">The y-coordinate of the point to compute the distance to.</param>
        /// <returns>
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double DistanceToSquared(PointD point) => this.DistanceToSquared(point.X, point.Y);
    }
