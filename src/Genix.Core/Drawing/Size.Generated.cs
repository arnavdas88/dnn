...
//     Generated on: 10/26/2018 12:28:06 PM
//
...
namespace Genix.Drawing
{
        ...
        : IEquatable<Size>
    {
        ...
        {
            return new Size(
                (int)Math.Round((dx * size.width) + Size.Eps, MidpointRounding.AwayFromZero),
                (int)Math.Round((dy * size.height) + Size.Eps, MidpointRounding.AwayFromZero));
        }
        ...
        {
            this.width = (int)Math.Round((dx * this.width) + Size.Eps, MidpointRounding.AwayFromZero);
            this.height = (int)Math.Round((dy * this.height) + Size.Eps, MidpointRounding.AwayFromZero);
        }
    }
