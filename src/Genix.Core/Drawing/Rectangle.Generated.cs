...
//     Generated on: 11/14/2018 4:50:04 PM
//
...
namespace Genix.Drawing
{
        ...
        : IEquatable<Rectangle>
    {
        ...
        /// </para>
        /// <para>
        /// If <paramref name="left"/> and <paramref name="right"/> sum is negative, the <see cref="Rectangle"/> structure is deflated along its x-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Width"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="Rectangle.Empty"/> rectangle.</para>
        /// </remarks>
        public static Rectangle InflateX(Rectangle rect, int left, int right)
        {
            return new Rectangle(
                rect.x - left,
                rect.y,
        ...
        /// </para>
        /// <para>
        /// If <paramref name="top"/> and <paramref name="bottom"/> sum is negative, the <see cref="Rectangle"/> structure is deflated along its y-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Height"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="Rectangle.Empty"/> rectangle.</para>
        /// </remarks>
        public static Rectangle InflateY(Rectangle rect, int top, int bottom)
        {
            return new Rectangle(
                rect.x,
                rect.y - top,
        ...
        /// <summary>
        /// Translates the specified <see cref="Rectangle"/> by the specified <see cref="Point"/>.
        /// </summary>
        /// <param name="rect">The <see cref="Rectangle"/> to translate.</param>
        ...
        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="Rectangle"/> structure along its x-axis.
        /// </summary>
        /// <param name="rect">The <see cref="Rectangle"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="Rectangle"/> structure along its x-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsX(Rectangle rect)
        {
            return this.x <= rect.x && rect.x + rect.w <= this.x + this.w;
        }

        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="Rectangle"/> structure along its y-axis.
        /// </summary>
        /// <param name="rect">The <see cref="Rectangle"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="Rectangle"/> structure along its y-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsY(Rectangle rect)
        {
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="Rectangle.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateX(int left, int right)
        {
            this.x -= left;
            this.w = MinMax.Max(this.w + left + right, 0);
        }
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="Rectangle.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateY(int top, int bottom)
        {
            this.y -= top;
            this.h = MinMax.Max(this.h + top + bottom, 0);
        }
        ...
        /// <summary>
        /// Replaces this <see cref="Rectangle"/> with the intersection of itself and the specified rectangular area.
        /// </summary>
        ...
        {
            int x1 = MinMax.Max(this.x, x);
            int x2 = MinMax.Min(this.x + this.w, x + width);
            int y1 = MinMax.Max(this.y, y);
            int y2 = MinMax.Min(this.y + this.h, y + height);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Intersect(Rectangle rect) => this.Intersect(rect.x, rect.y, rect.w, rect.h);
        ...
        /// <summary>
        /// Translates this <see cref="Rectangle"/> by the specified <see cref="Point"/>.
        /// </summary>
        ...
        : IEquatable<RectangleF>
    {
        ...
        /// </para>
        /// <para>
        /// If <paramref name="left"/> and <paramref name="right"/> sum is negative, the <see cref="RectangleF"/> structure is deflated along its x-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Width"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleF.Empty"/> rectangle.</para>
        /// </remarks>
        public static RectangleF InflateX(RectangleF rect, float left, float right)
        {
            return new RectangleF(
                rect.x - left,
                rect.y,
        ...
        /// </para>
        /// <para>
        /// If <paramref name="top"/> and <paramref name="bottom"/> sum is negative, the <see cref="RectangleF"/> structure is deflated along its y-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Height"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleF.Empty"/> rectangle.</para>
        /// </remarks>
        public static RectangleF InflateY(RectangleF rect, float top, float bottom)
        {
            return new RectangleF(
                rect.x,
                rect.y - top,
        ...
        /// <summary>
        /// Translates the specified <see cref="RectangleF"/> by the specified <see cref="PointF"/>.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleF"/> to translate.</param>
        ...
        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleF"/> structure along its x-axis.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleF"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleF"/> structure along its x-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsX(RectangleF rect)
        {
            return this.x <= rect.x && rect.x + rect.w <= this.x + this.w;
        }

        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleF"/> structure along its y-axis.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleF"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleF"/> structure along its y-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsY(RectangleF rect)
        {
            return this.y <= rect.y && rect.y + rect.h <= this.y + this.h;
        }
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleF.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateX(float left, float right)
        {
            this.x -= left;
            this.w = MinMax.Max(this.w + left + right, 0);
        }
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleF.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateY(float top, float bottom)
        {
            this.y -= top;
            this.h = MinMax.Max(this.h + top + bottom, 0);
        }
        ...
        /// <summary>
        /// Replaces this <see cref="RectangleF"/> with the intersection of itself and the specified rectangular area.
        /// </summary>
        /// <param name="x">The x-coordinate of the top-left corner of the rectangular area with which to intersect.</param>
        /// <param name="y">The y-coordinate of the top-left corner of the rectangular area with which to intersect.</param>
        /// <param name="width">The width of the rectangular area with which to intersect.</param>
        /// <param name="height">The height of the rectangular area with which to intersect.</param>
        public void Intersect(float x, float y, float width, float height)
        {
            float x1 = MinMax.Max(this.x, x);
            float x2 = MinMax.Min(this.x + this.w, x + width);
            float y1 = MinMax.Max(this.y, y);
            float y2 = MinMax.Min(this.y + this.h, y + height);
        ...
        /// <param name="rect">The rectangle with which to intersect.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Intersect(RectangleF rect) => this.Intersect(rect.x, rect.y, rect.w, rect.h);
        ...
        /// <summary>
        /// Translates this <see cref="RectangleF"/> by the specified <see cref="PointF"/>.
        /// </summary>
        ...
        : IEquatable<RectangleD>
    {
        ...
        /// </para>
        /// <para>
        /// If <paramref name="left"/> and <paramref name="right"/> sum is negative, the <see cref="RectangleD"/> structure is deflated along its x-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Width"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleD.Empty"/> rectangle.</para>
        /// </remarks>
        public static RectangleD InflateX(RectangleD rect, double left, double right)
        {
            return new RectangleD(
                rect.x - left,
                rect.y,
        ...
        /// </para>
        /// <para>
        /// If <paramref name="top"/> and <paramref name="bottom"/> sum is negative, the <see cref="RectangleD"/> structure is deflated along its y-axis.
        /// </para>
        /// <para>
        /// If the specified parameters shrink the rectangle by more than its current <see cref="Height"/>
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleD.Empty"/> rectangle.</para>
        /// </remarks>
        public static RectangleD InflateY(RectangleD rect, double top, double bottom)
        {
            return new RectangleD(
                rect.x,
                rect.y - top,
        ...
        /// <summary>
        /// Translates the specified <see cref="RectangleD"/> by the specified <see cref="PointD"/>.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleD"/> to translate.</param>
        ...
        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleD"/> structure along its x-axis.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleD"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleD"/> structure along its x-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsX(RectangleD rect)
        {
            return this.x <= rect.x && rect.x + rect.w <= this.x + this.w;
        }

        /// <summary>
        /// Determines if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleD"/> structure along its y-axis.
        /// </summary>
        /// <param name="rect">The <see cref="RectangleD"/> to test.</param>
        /// <returns>
        /// <b>true</b> if the rectangular region represented by <paramref name="rect"/> is contained within this <see cref="RectangleD"/> structure along its y-axis; otherwise, <b>false</b>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool ContainsY(RectangleD rect)
        {
            return this.y <= rect.y && rect.y + rect.h <= this.y + this.h;
        }
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleD.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateX(double left, double right)
        {
            this.x -= left;
            this.w = MinMax.Max(this.w + left + right, 0);
        }
        ...
        /// giving the rectangle a negative area, the rectangle becomes the <see cref="RectangleD.Empty"/> rectangle.</para>
        /// </remarks>
        public void InflateY(double top, double bottom)
        {
            this.y -= top;
            this.h = MinMax.Max(this.h + top + bottom, 0);
        }
        ...
        /// <summary>
        /// Replaces this <see cref="RectangleD"/> with the intersection of itself and the specified rectangular area.
        /// </summary>
        /// <param name="x">The x-coordinate of the top-left corner of the rectangular area with which to intersect.</param>
        /// <param name="y">The y-coordinate of the top-left corner of the rectangular area with which to intersect.</param>
        /// <param name="width">The width of the rectangular area with which to intersect.</param>
        /// <param name="height">The height of the rectangular area with which to intersect.</param>
        public void Intersect(double x, double y, double width, double height)
        {
            double x1 = MinMax.Max(this.x, x);
            double x2 = MinMax.Min(this.x + this.w, x + width);
            double y1 = MinMax.Max(this.y, y);
            double y2 = MinMax.Min(this.y + this.h, y + height);
        ...
        /// <param name="rect">The rectangle with which to intersect.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Intersect(RectangleD rect) => this.Intersect(rect.x, rect.y, rect.w, rect.h);
        ...
        /// <summary>
        /// Translates this <see cref="RectangleD"/> by the specified <see cref="PointD"/>.
        /// </summary>
