...
//     Generated on: 10/29/2018 10:08:08 AM
//
...
namespace System
{
    ...
    public static class NumericExtensions
    {
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Round(this float value, MidpointRounding mode)
        {
            return (int)Math.Round(value + NumericExtensions.Eps, mode);
        }
