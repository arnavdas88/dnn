...
//     Generated on: 9/12/2018 5:33:00 PM
//
...
namespace Genix.Imaging
{
    ...
    public partial class Image
    {
        ...
        /// </summary>
        /// <param name="a">The left-side operand of this operation.</param>
        /// <param name="b">The right-side operand of this operation.</param>
        /// <remarks>
        /// <para>
        ...
        /// The <see cref="Image{T}.BitsPerPixel"/> properties of <paramref name="src"/> and this <see cref="Image"/> are not the same.
        /// </exception>
        public void And(Image src)
        {
            this.AndIP(0, 0, Core.MinMax.Min(this.Width, src.Width), Core.MinMax.Min(this.Height, src.Height), src, 0, 0);
        }
        ...
        /// The <see cref="Image{T}.BitsPerPixel"/> properties of <paramref name="src"/> and this <see cref="Image"/> are not the same.
        /// </exception>
        public void Or(Image src)
        {
            this.OrIP(0, 0, Core.MinMax.Min(this.Width, src.Width), Core.MinMax.Min(this.Height, src.Height), src, 0, 0);
        }
        ...
        /// The <see cref="Image{T}.BitsPerPixel"/> properties of <paramref name="src"/> and this <see cref="Image"/> are not the same.
        /// </exception>
        public void Xor(Image src)
        {
            this.XorIP(0, 0, Core.MinMax.Min(this.Width, src.Width), Core.MinMax.Min(this.Height, src.Height), src, 0, 0);
        }
        ...
        /// The <see cref="Image{T}.BitsPerPixel"/> properties of <paramref name="a"/> and <paramref name="b"/> are not the same.
        /// </exception>
        public static Image Xand(Image a, Image b)
        {
            if (a == null)
            {
                throw new ArgumentNullException(nameof(a));
        ...
        /// The <see cref="Image{T}.BitsPerPixel"/> properties of <paramref name="src"/> and this <see cref="Image"/> are not the same.
        /// </exception>
        public void Xand(Image src)
        {
            this.XandIP(0, 0, Core.MinMax.Min(this.Width, src.Width), Core.MinMax.Min(this.Height, src.Height), src, 0, 0);
        }
