...
//     Generated on: 9/24/2018 5:17:35 PM
//
...
namespace Genix.Imaging
{
    ...
    public partial class Image
    {
        ...
        /// 
        /// </remarks>
        /// <seealso cref="SetToOneIP()"/>
        public Image SetToOne()
        {
        ...
        /// </exception>
        /// <seealso cref="SetToOneIP(int, int, int, int)"/>
        public Image SetToOne(int x, int y, int width, int height)
        {
            ...
            {
                Image dst = this.Copy();
                dst.SetToOneIP(x, y, width, height);
                return dst;
            }
        }
        ...
        /// </exception>
        /// <seealso cref="SetToOneIP(Rectangle)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Image SetToOne(Rectangle rect) => this.SetToOne(rect.X, rect.Y, rect.Width, rect.Height);
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetToOneIP(int x, int y, int width, int height)
        {
            this.SetColorIP(x, y, width, height, uint.MaxValue);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetToOneIP(Rectangle rect) => this.SetToOneIP(rect.X, rect.Y, rect.Width, rect.Height);
        ...
        /// 
        /// </remarks>
        /// <seealso cref="SetToZeroIP()"/>
        public Image SetToZero()
        {
            Image dst = this.Clone(false);
        ...
        /// The rectangular area described by <paramref name="x"/>, <paramref name="y"/>, <paramref name="width"/> and <paramref name="height"/> is outside of image bounds.
        /// </exception>
        /// <seealso cref="SetToZeroIP(int, int, int, int)"/>
        public Image SetToZero(int x, int y, int width, int height)
        {
            if (x == 0 && y == 0 && width == this.Width && height == this.Height)
            {
            ...
            {
                Image dst = this.Copy();
                dst.SetToZeroIP(x, y, width, height);
                return dst;
            }
        }
        ...
        /// The rectangular area described by <paramref name="rect"/> is outside of image bounds.
        /// </exception>
        /// <seealso cref="SetToZeroIP(Rectangle)"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Image SetToZero(Rectangle rect) => this.SetToZero(rect.X, rect.Y, rect.Width, rect.Height);
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetToZeroIP(int x, int y, int width, int height)
        {
            this.SetColorIP(x, y, width, height, 0);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetToZeroIP(Rectangle rect) => this.SetToZeroIP(rect.X, rect.Y, rect.Width, rect.Height);
        ...
        {
            this.SetColorIP(x, y, width, height, this.BitsPerPixel == 1 ? 0 : uint.MaxValue);
        }
        ...
        {
            this.SetColorIP(x, y, width, height, this.BitsPerPixel == 1 ? uint.MaxValue : 0);
        }
        ...
        {
            return this.SetBorder(x, y, width, height, BorderType.BorderConst, this.BitsPerPixel == 1 ? 0 : uint.MaxValue);
        }
        ...
        {
            this.SetBorderIP(x, y, width, height, BorderType.BorderConst, this.BitsPerPixel == 1 ? 0 : uint.MaxValue);
        }
        ...
        {
            return this.SetBorder(x, y, width, height, BorderType.BorderConst, this.BitsPerPixel == 1 ? uint.MaxValue : 0);
        }
        ...
        {
            this.SetBorderIP(x, y, width, height, BorderType.BorderConst, this.BitsPerPixel == 1 ? uint.MaxValue : 0);
        }
