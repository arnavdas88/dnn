namespace Accord.DNN.Test
{
    ...
    public class GRULayerTest
    {
        ...
        public void ConstructorTest1()
        {
            ...
            GRULayer layer = new GRULayer(shape, new[] { 20, 30 }, MatrixLayout.ColumnMajor, null);
        ...
        public void XorTest1()
        {
            ...
            (Tensor, int[]) createSample(int size)
            {
                ...
                for (int i = 0; i < size; i++)
                {
                    ...
                    MKL.Copy(VectorSize, vectors, v * VectorSize, input.Weights, i * VectorSize);
        ...
        public void TinyShakespeareTest1()
        {
            ...
            foreach (string w in words.Where(x => x.Length > 1))
            {
                ...
                {
                    MKL.Copy(letterSize, letters.Weights, alphabet[w1[i]] * letterSize, x.Weights, i * letterSize);
                }
